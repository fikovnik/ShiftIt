...
- (void) initializeActions_ {
	...
	ShiftItAction *left23 = [[ShiftItAction alloc] initWithIdentifier:@"left23" label:@"Left 2/3rds" uiTag:11 action:&ShiftIt_Left_Two_Thirds];
	[dict setObject:left23 forKey:[left23 identifier]];
	ShiftItAction *right13 = [[ShiftItAction alloc] initWithIdentifier:@"right13" label:@"Right 1/3rd" uiTag:12 action:&ShiftIt_Right_One_Third];

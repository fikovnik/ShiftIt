...
You can use the <img src="https://github.com/Hammerspoon/hammerspoon/blob/master/Hammerspoon/Images.xcassets/AppIcon.appiconset/32.png?raw=true" height="18" valign="middle" /> [ShiftIt Spoon](https://github.com/peterklijn/hammerspoon-shiftit) which implements the ShiftIt functionality in Hammerspoon.
